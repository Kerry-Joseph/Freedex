const Index = ({ setIdState, index}) => {
    ...
    const loaded = () => {
        return index.map((game) => (
            ...
            className="cursor-pointer bg-FGI_white flex flex-col md:flex-row [&_h1]:hover:text-black rounded-lg 
            items-center mx-4 my-2 lg:max-h-[9.7rem]">
